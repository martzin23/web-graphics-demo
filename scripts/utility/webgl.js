...
export function createTexture(gl, width, height, format = "RGBA8", filter = "LINEAR", warp_mode = "WRAP", data = null) {
    const formats = {
    ...
    gl.texImage2D(gl.TEXTURE_2D, 0, gl[format], width, height, 0, formats[format].channels, formats[format].type, data);
